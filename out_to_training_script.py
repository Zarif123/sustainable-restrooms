...
bit = 3
out_to_training(class_type='urination', bits=bit)
out_to_training(class_type='defecation', bits=bit)
out_to_training(class_type='speech', bits=bit)
out_to_training(class_type='noise', bits=bit)
out_to_training(class_type='silence', bits=bit)